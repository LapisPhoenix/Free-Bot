...
class Xp:
    def calc_xp(level:int): # The formula used to calculate the xp needed to level up, gotten from https://blog.jakelee.co.uk/converting-levels-into-xp-vice-versa/
