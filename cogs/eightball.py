...
class Eightball(commands.Cog):
    ...
    async def eightball(self, ctx, *, question:str = None):  # question does nothing, but it is required
        if question is None:
            ...
            bot_options = ["🟢 It is certain.", "🟢 Without a doubt.", "🟢 Yes definitely.", "🟡 Better not tell you now.", "🟡 Cannot predict now.", "🟡 Concentrate and ask again.", "🔴 Don't count on it.", "🔴 My sources say no.", "🔴 Very doubtful."]  # Possible bot choices
