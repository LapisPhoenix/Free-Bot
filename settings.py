...
max_warns_ban: int = 5  # The max amount of warns a user can have before they are banned, set to "None" to disable   (THIS WILL INSTANTLY BAN)
...
class Leveling:  # Leveling settings
    ...
    LEVEL_UP_MESSAGE: str = "Congrats **{user}** you leveled up to level **{level}**!"  # The message sent when a user levels up
